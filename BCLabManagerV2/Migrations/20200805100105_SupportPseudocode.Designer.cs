...
namespace BCLabManager.Migrations
{
    ...
    [Migration("20200805100105_SupportPseudocode")]
    partial class SupportPseudocode
    {
            ...
            modelBuilder.Entity("BCLabManager.Model.Protection", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_protection");

                    b.HasIndex("RecipeTemplateId")
                        .HasName("ix_protection_recipe_template_id");
            ...
            modelBuilder.Entity("BCLabManager.Model.Protection", b =>
                {
                    b.HasOne("BCLabManager.Model.RecipeTemplate", null)
                        ...
                        .HasConstraintName("fk_protection_recipe_templates_recipe_template_id");
                });

...
namespace BCLabManager.ViewModel
{
    ...
    /// </summary>
    public class DischargeTemperatureEditViewModel : ViewModelBase//, IDataErrorInfo
    {
        #region Fields
        public readonly DischargeTemperatureClass _chargeTemperature;            //为了将其添加到Program里面去(见ProgramViewModel Add)，不得不开放给viewmodel。以后再想想有没有别的办法。
        ...
        public DischargeTemperatureEditViewModel(DischargeTemperatureClass chargeTemperature)
        {

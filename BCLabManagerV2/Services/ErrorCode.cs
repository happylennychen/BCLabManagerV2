...
namespace BCLabManager
{
    public static class ErrorCode
    {
        ...
        public const UInt32 DP_ABNORMAL_STEP_AND_TIME_JUMP = DATA_PREPROCESSOR_OFFSET + 0x00000006;
        ...
        public static string GetDescription(UInt32 errorcode, params object[] args)
        {
            switch(errorcode)
            {
                ...
                case ErrorCode.DP_ABNORMAL_STEP_AND_TIME_JUMP:
                    return "Abnormal step and time jump.";

...
namespace BCLabManager
{
    public static class GlobalSettings
    {
        ...
        public static string RunningLogFilePath { get; set; } = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Running Log\\", $"{DateTime.Now.ToString("yyyyMMddHHmmss")}.log");

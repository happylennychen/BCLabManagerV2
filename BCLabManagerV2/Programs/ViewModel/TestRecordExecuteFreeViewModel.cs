...
namespace BCLabManager.ViewModel
{
    ...
    /// </summary>
    public class TestRecordExecuteFreeViewModel : BindableBaseWithName//, IDataErrorInfo
    {
        #region Fields
        //string _programName;
        //string _RecipeName;
        ...
        ObservableCollection<BatteryType> _batteryTypes;
        ObservableCollection<Battery> _allBatteries;
        Battery _battery;
        ...
        public TestRecordExecuteFreeViewModel(
            TestRecord record,
        ObservableCollection<BatteryType> batteryTypes,
        ...
        public ObservableCollection<Battery> AllBatteries    //供选项
        {
            get
            {
                if (_allBatteries == null)
                {
                    _allBatteries = new ObservableCollection<Battery>();
                }
        ...
        public BatteryType BatteryType
        {
            ...
            set
            {
                ...
                ObservableCollection<Battery> all = _batteries;
                List<Battery> allstring = (
                    from i in all
                    where (i.BatteryType.Id == _batteryType.Id) && i.AssetUseCount == 0
                    select i).ToList();

                AllBatteries = new ObservableCollection<Battery>(allstring);
            }
        }
        public ObservableCollection<BatteryType> AllBatteryTypes    //供选项
        {
            get
            {
                ObservableCollection<BatteryType> all = _batteryTypes;

                return new ObservableCollection<BatteryType>(all);
            }
        }

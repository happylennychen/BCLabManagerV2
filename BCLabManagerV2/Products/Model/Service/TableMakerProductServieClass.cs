...
namespace BCLabManager.Model
{
    public class TableMakerProductServiceClass
    {
        ...
        public void FileOperation(TableMakerProduct item)
        {
            ...
            string temproot = $@"{GlobalSettings.TempraryFolder}{item.Project.BatteryType.Name}\{item.Project.Name}";
        ...
        private string CopyToFolder(string filepath, string root)
        {
            ...
            //var tempPath = Path.Combine($@"{GlobalSettings.TempraryFolder}{GlobalSettings.ProductFolderName}", Path.GetFileName(filepath));
